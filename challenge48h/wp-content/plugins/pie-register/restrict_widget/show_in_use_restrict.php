		...
		echo '<td valign="top">';
            ...
            <div style="width:100%;display:inline-block;">
            	<fieldset  style="padding:5px 5px;">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <label><input <?php echo (($visibility_status == "Before Login") ? 'checked="checked"' : ""); ?> type="checkbox" value="visibility_status=Before Login" id="pr_ristrict_widget_before_login" /><?php _e("Show to users who have not logged in.","pie-register"); ?></label>
                    &nbsp;&nbsp;&nbsp;
