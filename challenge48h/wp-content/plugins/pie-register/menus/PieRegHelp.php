  ...
  <div class="right_section">
    <div class="settings">
      ...
      <?php 
		...
		?>
        <div class="pie-help-left"> <!-- pie-help-left -->
                ...
                <?php
                    ...
                    <?php
                        ...
                        elseif( isset($this->pie_post_array['success']) && !empty($this->pie_post_array['success']) ){
                            echo '<div id="message" class="updated fade msg_belowheading"><p><strong>' . $this->pie_post_array['success'] . '</strong></p></div>';
                        }
        ...
        <div class="pie-help-right">
            <div id="pie_embed_signup">
                <iframe width="400" height="700" src="https://66ac0bda.sibforms.com/serve/MUIEANvBtAVqBEsGGAUKS8nDivqo2Z841r6frdZildNSEeJZfm2khsj1O0ZHuvxkFYt_CDlJqB34Psv2VvFunUVj89yi4QQEE2kgM0Ieu-8lxwI_pAjMrLWKR8Uf_hhA34H_uzTjkMDYF6sgSwpbJDj3mmUqor7WBTujGuOBRuMkWsiAEtheEK3XFDW5uAks_3TnXCHTbMhtTrxM" frameborder="0" scrolling="auto" allowfullscreen style="display: block;margin-left: auto;margin-right: auto;max-width: 100%;"></iframe>
            </div>
        </div>    
    </div>
  </div>
